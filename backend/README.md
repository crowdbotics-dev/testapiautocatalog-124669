...
## Project Structure
    ...
    ├── testapiautocatalog_124669  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_124669`
...
2. Clone this repo and `cd testapiautocatalog_124669`
